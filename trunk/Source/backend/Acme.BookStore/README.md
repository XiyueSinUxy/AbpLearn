...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 84d3b206-2978-46ca-b920-8429e6fc21b0
```

> `84d3b206-2978-46ca-b920-8429e6fc21b0` is the password of the certificate, you can change it to any password you want.
